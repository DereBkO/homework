...
const stand = "Стандарт";
const expre = "Экспресс";
const prem = "Премиум";

const weight = prompt('Введите все посылки (в килограммах):');
const checkType = prompt('Стандарт, Экспресс, Премиум');
...
} else if (checkType !== stand && checkType !== expre && checkType !== prem) {
...
const price = weight < 1 ? 5 :
            weight <= 5 ? 10 :
            15;

alert(`Базовая стоимость — ${price}$`);
...
switch (true) {
    case (checkType === stand):
        alert('"Стандарт": коэффициент 1');
        break;
    case (checkType === expre):
        alert('"Экспресс": коэффициент 1.5');
        break;
    case (checkType === prem):
        alert('"Премиум": коэффициент 2');
        break;
}
...
if (checkType === stand) {
    alert("Итоговая стоимость доставки: " + price * 1 + "$.");
} else if (checkType === expre) {
    alert("Итоговая стоимость доставки: " + price * 1.5 + "$.");
} else if (checkType === prem) {
    alert("Итоговая стоимость доставки: " + price * 2 + "$.");
}